...
class Field:
	...
	def _getMovesRepr(moves):
		...
		return "".join(move.dir_.name[0] for move in moves)
...
if __name__ == "__main__":
	...
	# 	Cell.empty(),  Cell.empty(), Cell.empty(), Cell.empty(),     Cell.goal(),  Cell.empty(),
	# 	Cell.runner(), Cell.empty(), Cell.empty(), Cell.wall(),      Cell.wall(),  Cell.empty(),
	# 	Cell.empty(),  Cell.empty(), Cell.empty(), Cell.empty(),     Cell.box(), Cell.box(),
	# 	Cell.goal(),   Cell.box(),   Cell.empty(), Cell.box(),       Cell.box(), Cell.empty(),
	# 	Cell.box(),    Cell.box(),   Cell.box(),   Cell.box(),       Cell.empty(),  Cell.empty(),
	# 	Cell.goal(),   Cell.box(),  Cell.box(),  Cell.empty(),      Cell.empty(), Cell.empty()
	# ])
